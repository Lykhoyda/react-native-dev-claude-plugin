...
- [ ] **Step 3: Verify the file is not in plugin.json**
...
- [ ] **Step 1: Add evaluator reference to Phase 1**
...
- [ ] **Step 2: Add evaluator reference to Phase 2**
...
- [ ] **Step 3: Add evaluator reference to Phase 3**
...
- [ ] **Step 4: Add evaluator reference to Phase 4**
...
- [ ] **Step 5: Add evaluator reference to Phase 5**
...
- [ ] **Step 6: Add evaluator reference to Phase 5.5**
...
- [ ] **Step 7: Add evaluator reference to Phase 6**
...
- [ ] **Step 8: Add evaluator reference to Phase 7**
...
- [ ] **Step 9: Verify all 8 phases have evaluator references**
...
- [ ] **Step 1: Append Phase 18 to ROADMAP.md**
...
- [ ] **Step 2: Append D207-D209 to DECISIONS.md**
...
- [ ] **Step 1: Verify dev/evaluator.md exists and is not in plugin manifest**
...
- [ ] **Step 2: Verify docs/reports/ directory exists**

```bash
ls docs/reports/.gitkeep
```

- [ ] **Step 3: Verify all 8 evaluator references in rn-feature-dev.md**

Search for `**Evaluator**:` in `commands/rn-feature-dev.md` — expect exactly 8 matches covering Phases 1, 2, 3, 4, 5, 5.5, 6, 7.

- [ ] **Step 4: Verify ROADMAP and DECISIONS updated**
