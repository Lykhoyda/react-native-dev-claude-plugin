...
trackedTool('device_press', 'Tap a UI element by its @ref from device_snapshot. Simulates a native touch event. Requires an open session.', {
...
trackedTool('device_swipe', 'Swipe on the device screen. Use for scrolling, pull-to-refresh, or dismissing modals. Requires an open session.', {
