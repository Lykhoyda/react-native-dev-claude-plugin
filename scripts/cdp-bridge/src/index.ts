...
server.tool(
  'cdp_store_state',
  'Read app store state (Redux, Zustand). Use path to query specific slice (e.g. "cart.items", "auth.user.name"). Redux auto-detected via fiber Provider. Zustand requires: if (__DEV__) global.__ZUSTAND_STORES__ = { store }',
  {
